export const history = [
    ...
    // paragraph
    [ "Pac-Man es un icónico videojuego arcade creado por Toru Iwatani y lanzado por Namco en 1980.",
        "El juego se centra en un personaje amarillo con forma de pizza llamado Pac-Man, que vive en un laberinto y su objetivo es comer todos los puntos mientras evita a los fantasmas.",
        "Cuando come una 'superpíldora', puede volverse temporalmente invulnerable y comer a los fantasmas",
